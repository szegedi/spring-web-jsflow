 ...
 * {@link org.szegedi.spring.web.jsflow.support.AbstractFlowStateStorage} to
 * transform the binary representation of the serialized state. Tipically, you
 * will add codecs when using
